...
INSERT INTO "news" ("id","title","descr","version","create_date") VALUES (1,'Была добавлена страница "Что нового"','<p>На этой странице будет публиковаться информация об обновлениях и различных нововведениях, связанных с этим проектом, а так же уведомления о различных скидках и акциях</p>
','0.22','2025-01-09 04:11:28');
